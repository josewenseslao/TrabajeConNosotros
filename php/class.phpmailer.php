...
class PHPMailer
{
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        $PHPMAILER_LANG = array(
            'authenticate' => 'SMTP Error: No se pudo autenticar. ',
            'connect_host' => 'SMTP Error: No pudo conectar al servidor SMTP. ',
            'data_not_accepted' => 'SMTP Error: datos no aceptados. ',
            'empty_message' => 'El cuerpo del mensaje vacío ',
            'encoding' => 'codificación desconocida: ',
            'execute' => 'No se pudo ejecutar: ',
            'file_access' => 'No puedo acceder al archivo: ',
            'file_open' => 'File Error: No se pudo abrir el archivo: ',
            'from_failed' => 'Las siguientes direcciones de remitente fallaron: ',
            ...
            'provide_address' => 'Debe proveer al menos una dirección de correo electrónico del destinatario. ',
            'recipients_failed' => 'SMTP Error: Los siguientes destinatarios fallaron: ',
            'signing' => 'Signing Error: ',
            'smtp_connect_failed' => 'SMTP connect() fallida. ',
